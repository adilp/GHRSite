  ...
  return (
    <>
      ...
      <main className='min-h-screen'>
        ...
        <section className='relative h-screen md:h-[70vh] w-full overflow-hidden'>
          ...
          <div className='relative z-10 flex flex-col items-center justify-center h-full text-white px-4'>
            ...
            <div className='flex flex-col sm:flex-row gap-3 sm:gap-4 mt-4'>
              <button className='bg-rotary-gold text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold hover:bg-opacity-90 transition-all hover:scale-105 shadow-lg text-sm sm:text-base'>
                Join Us
              </button>
              <button className='bg-white/20 backdrop-blur-sm text-white border-2 border-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold hover:bg-white/30 transition-all hover:scale-105 text-sm sm:text-base'>
                Learn More
              </button>
            </div>
          </div>
        ...
        <section className='relative overflow-hidden bg-off-white min-h-[50vh] py-16 md:py-0 md:h-[50vh] flex items-center'>
